...
class Configuration():
    ...
    def load_categorizer_config(self):
        ...
        try: 
            ...
            log(Log.ERROR, f"Invalid YAML contained in config file '{self.categorizer_path}': {error.context} {error.problem} near [{error.context_mark.line}, {error.context_mark.column}]")
            log(Log.WARNING, f"Using default categorizer. Continuing execution.")
